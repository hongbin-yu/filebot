...
# Last notification was 15h at 12:08 UTC, now 12:41 UTC
# So about 15.55 hours
stop_duration_hours = 15.55
...
# Last frontend stop notification was at 12:08 (15h), about 33 minutes ago
# According to HEARTBEAT.md, "定期维护提醒" should be notified at next heartbeat
# Add notification for 15.5h mark
new_notif = {
