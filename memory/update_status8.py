...
# That's about 13.8 hours ago
stop_duration_hours = 13.8
...
# Last frontend stop notification was at 09:53, more than 1 hour ago (42 minutes)
# According to HEARTBEAT.md, key service stops should be notified immediately
# But we're already notifying hourly at milestone marks (12h, 13h, etc.)
# Let's check if it's been more than 1.5 hours since last notification
...
# If no notification or last notification >1.5 hours ago, add new
if last_notification_time is None or (datetime.fromisoformat(now.replace('Z', '+00:00')).timestamp() - last_notification_time) > 5400:
    new_notif = {
