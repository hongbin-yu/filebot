...
def clean_content(content, page_id):
    """Simulate JavaScript cleanContent function"""
...
def test_avis_page():
    """Test cleaning the avis page"""
    print("Testing avis page cleaning...")
    ...
    # Test cleaning
    cleaned = clean_content(content, 'avis')
