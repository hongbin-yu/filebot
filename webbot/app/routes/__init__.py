...
try:
    ...
    print("⚠️  Mustache路由导入失败，Mustache功能将不可用")
    MUSTACHE_ENABLED = False
    mustache_router = None

__all__ = ["pages_router", "ai_router", "files_router", "components_router", "mustache_router", "COMPONENTS_ENABLED", "FILES_ENABLED", "MUSTACHE_ENABLED"]