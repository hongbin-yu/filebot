...
details_lines.append(f"📡 WhatsApp网关: 17:58断开(503), 17:59重连; 18:22断开(503), 18:23重连 (短暂断开后自动恢复)")
...
new_task = {
    "id": task_id,
    "description": "定期心跳检查 - 所有核心服务稳定运行，WhatsApp网关短暂断开后恢复",
    "completed": now,
    "notified": False,
    "status": "success",
    "details": details
...
print("Updated heartbeat status with WhatsApp gateway events")